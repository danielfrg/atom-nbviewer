...
describe "Nbviewer", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('nbviewer')

  describe "when the nbviewer:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'nbviewer:toggle'
        expect(nbviewerPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'nbviewer:toggle'
        expect(nbviewerElement).not.toBeVisible()
